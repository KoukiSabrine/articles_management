...
public class ArticleController {
    ...
    @GetMapping("/listByPovider/{providerId}")
    public List<Article> getArticlesByProvider(@PathVariable (value = "providerId") Long providerId) {
        return (List<Article>) articleRepository.getArticlesByProviderId(providerId);
    }
